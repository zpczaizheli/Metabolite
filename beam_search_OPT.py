        ...
        for mod in range(len(model_list)):
            ...
            for j in range(len(b)):
                ...
                try:
                    ...
                    if mod == 0:
                        if num_t / num_s > 0.63 and 0.494 < gb < 1:
                            top15_list.append((b[len(b) - j - 1][1], smi_pred, "oxidation"))
                    elif mod == 1 and num_t - num_s >= 3:
                        if num_t / num_s > 1.1 and 0.47 < gb < 1:
                            top15_list.append((b[len(b) - j - 1][1], smi_pred, "combination"))
                    elif mod == 2 and num_s - num_t >= 2:
                        if num_t / num_s > 0.33 and 0.52 < gb < 1:
                            top15_list.append((b[len(b) - j - 1][1], smi_pred, "hydrolysis"))
