...
if __name__ == "__main__":
    ...
    # 读取val数据
    data_v = pd.read_csv(r"/home/user06/model/data/valid_data_oxidation.csv")
    Sentences_v = []
